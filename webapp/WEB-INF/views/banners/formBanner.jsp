...
<title>Crear imágenes del Banner | Village Cines</title>
<spring:url value="/resources" var="urlPublic"></spring:url>
<spring:url value="/banners/save" var="urlSaveForm"></spring:url>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<!--  En caso de error de bind se muestra un mensaje con los errores -->
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<!-- id del banner, para poder actualizarlo -->
						<form:hidden path="id" />
					</div>
				</div>
