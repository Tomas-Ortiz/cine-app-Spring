...
<title>Crear Noticia | Village Cines</title>

<spring:url value="/resources" var="urlPublic"></spring:url>
<spring:url value="/noticias/save" var="urlSave"></spring:url>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${urlSave}" method="post" modelAttribute="noticia">
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<!--  se guarda el id de noticia para luego poder actualizarlo -->
	...
	<script>
		//se configura tinymce (plugir de js para editor de texto) en donde se especifica con que se va a inicializar
		tinymce
				.init({
					selector : '#detalle',
