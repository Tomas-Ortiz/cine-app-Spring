...
<title>Contactános | Village Cines</title>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<!-- con el modelAtrribute se realiza el vinculo entre el form html y el objeto de modelo Contacto-->

		<form:form class="form-horizontal" method="post"
			action="${urlRoot}send" modelAttribute="contact">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Tu experiencia en el
					sitio</label>
				<div class="col-sm-10">
					<label><form:radiobutton path="experiencia" value="1" />Muy
						Mala</label> <label><form:radiobutton path="experiencia" value="2" />Mala</label>
					<label><form:radiobutton path="experiencia" value="3" />Regular</label>
					<label><form:radiobutton path="experiencia" value="4" />Buena</label>
					<label><form:radiobutton path="experiencia" value="5" />Muy
						Buena</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:textarea class="form-control" path="comentario"
						id="comentario" rows="5" />
				</div>
			</div>
